function WOWTR_CreateTutorialsTab(parent)
  local WOWTR_OptionsHeaderIcon4 = parent:CreateTexture(nil, "OVERLAY");
  WOWTR_OptionsHeaderIcon4:SetWidth(200);
  WOWTR_OptionsHeaderIcon4:SetHeight(200);
  WOWTR_OptionsHeaderIcon4:SetTexture(WoWTR_Localization.mainFolder .. "\\Images\\tutorials_mini.jpg"); -- parent thumbnail
  ...
  local WOWTR_Panel4Header1 = parent:CreateFontString(nil, "ARTWORK");
  ...
  if (WoWTR_Localization.lang == 'AR') then
    WOWTR_Panel4Header1:SetPoint("TOPLEFT", parent, "TOPLEFT", 445, -25);
  else
    WOWTR_Panel4Header1:SetPoint("TOPLEFT", parent, "TOPLEFT", 20, -25);
  end
  ...
  local WOWTR_CheckButton41 = CreateFrame("CheckButton", "WOWTR_CheckButton41", parent,
  ...
  local WOWTR_Panel4Header2 = parent:CreateFontString(nil, "ARTWORK");
  ...
  if (WoWTR_Localization.lang == 'AR') then
    WOWTR_Panel4Header2:SetPoint("TOPLEFT", parent, "TOPLEFT", 580, -100);
  else
    WOWTR_Panel4Header2:SetPoint("TOPLEFT", parent, "TOPLEFT", 20, -100);
  end
  ...
  local WOWTR_CheckButton42 = CreateFrame("CheckButton", "WOWTR_CheckButton42", parent,
    "UICheckButtonTemplate");
  ...
  if (#WOWTR_Fonts > 1) then
    local WOWTR_Panel4Header2f = parent:CreateFontString(nil, "ARTWORK");
    ...
    if (WoWTR_Localization.lang == 'AR') then
      WOWTR_Panel4Header2f:SetPoint("TOPLEFT", parent, "TOPLEFT", 545, -170);
    else
      WOWTR_Panel4Header2f:SetPoint("TOPLEFT", parent, "TOPLEFT", 20, -170);
    end
    ...
    local WOWTR_Panel4Header2g = parent:CreateFontString(nil, "ARTWORK");
    ...
    if (WoWTR_Localization.lang == 'AR') then
      WOWTR_Panel4Header2g:SetPoint("TOPLEFT", parent, "TOPLEFT", 300, -170);
    else
      WOWTR_Panel4Header2g:SetPoint("TOPLEFT", parent, "TOPLEFT", 290, -170);
    end
    ...
    local WOWTR_Panel4Header2h = parent:CreateFontString(nil, "ARTWORK");
    ...
    local WOWTR_Panel4SelectF = CreateFrame("Frame", "WOWTR_Panel4SelectF", parent,
      "UIDropDownMenuTemplate");
    WOWTR_Panel4SelectF:ClearAllPoints();
    if (WoWTR_Localization.lang == 'AR') then
      WOWTR_Panel4SelectF:SetPoint("TOPLEFT", parent, "TOPLEFT", 460, -195);
    else
      WOWTR_Panel4SelectF:SetPoint("TOPLEFT", parent, "TOPLEFT", 0, -195);
    end
    ...
    UIDropDownMenu_Initialize(WOWTR_Panel4SelectF, function(self, level, _)
      for i, font in ipairs(WOWTR_Fonts) do
        ...
        info.func = function(self, arg1, arg2, checked) -- function is called when option is clicked
          ...
          WOWTR_Panel4Header2h:SetText(self.value);
  ...
  local WOWTR_Panel4Separator = parent:CreateFontString(nil, "ARTWORK");
  ...
  WOWTR_Panel4Separator:SetPoint("TOPLEFT", parent, "TOPLEFT", 20, -250);
  local frame = parent:CreateTexture(nil, "BACKGROUND")
  frame:SetSize(684, 1)
  frame:SetPoint("TOPLEFT", 0, -240)
  frame:SetColorTexture(0.2, 0.2, 0.2, 1)

  local WOWTR_OptionsHeaderIcon5 = parent:CreateTexture(nil, "OVERLAY");
  WOWTR_OptionsHeaderIcon5:SetWidth(200);
  WOWTR_OptionsHeaderIcon5:SetHeight(200);
  WOWTR_OptionsHeaderIcon5:SetTexture(WoWTR_Localization.mainFolder .. "\\Images\\ui_mini.jpg"); -- parent thumbnail
  if (WoWTR_Localization.lang == 'AR') then
  ...
  local WOWTR_Panel4Header3 = parent:CreateFontString(nil, "ARTWORK");
  ...
  local WOWTR_Panel4Text1 = parent:CreateFontString(nil, "ARTWORK");
  ...
  local WOWTR_CheckButton43 = CreateFrame("CheckButton", "WOWTR_CheckButton43", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton45 = CreateFrame("CheckButton", "WOWTR_CheckButton45", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton46 = CreateFrame("CheckButton", "WOWTR_CheckButton46", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton50 = CreateFrame("CheckButton", "WOWTR_CheckButton50", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton47 = CreateFrame("CheckButton", "WOWTR_CheckButton47", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton48 = CreateFrame("CheckButton", "WOWTR_CheckButton48", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton49 = CreateFrame("CheckButton", "WOWTR_CheckButton49", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton40 = CreateFrame("CheckButton", "WOWTR_CheckButton40", parent,
    "UICheckButtonTemplate");
  ...
  WOWTR_ReloadButtonUI = CreateFrame("BUTTON", nil, parent, "UIPanelButtonTemplate");
  ...
  local WOWTR_Panel4Header4 = parent:CreateFontString(nil, "ARTWORK");
  ...
  local WOWTR_CheckButton44 = CreateFrame("CheckButton", "WOWTR_CheckButton44", parent,
    "UICheckButtonTemplate");
  ...
  WOWTR_ResetButton2 = CreateFrame("BUTTON", nil, parent, "UIPanelButtonTemplate");
  ...
  WOWTR_Confirmation2 = CreateFrame("Frame", nil, parent, "UIPanelDialogTemplate");
...
function WOWTR_UpdateTutorialsTab()
