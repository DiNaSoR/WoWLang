...
WoWTR_Localization = {
   ...
   WoWTR_Talent_trDESC = "Talenty: Polski",                          -- Talents: Polish
...
WoWTR_Config_Interface = {
   ...
   translateOwnNames = "Wyświetlaj nazwy własne miejsc po polsku",                                 -- Display own mames in polish language
   translateOwnNamesDESC = "Jeśli zaznaczono, nazwy własne miejsc w grze będą wyświetlane po polsku",   -- If enabled, own names of cities, places etc. will displaying in polish language
