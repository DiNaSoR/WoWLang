function WOWTR_CreateTooltipsTab(parent)
  local WOWTR_OptionsHeaderIcon7 = parent:CreateTexture(nil, "OVERLAY");
  WOWTR_OptionsHeaderIcon7:SetWidth(200);
  WOWTR_OptionsHeaderIcon7:SetHeight(200);
  WOWTR_OptionsHeaderIcon7:SetTexture(WoWTR_Localization.mainFolder .. "\\Images\\tooltips_mini.jpg"); -- parent thumbnail
  ...
  local WOWTR_Panel6Header1 = parent:CreateFontString(nil, "ARTWORK");
  ...
  if (WoWTR_Localization.lang == 'AR') then
    WOWTR_Panel6Header1:SetPoint("TOPLEFT", parent, "TOPLEFT", 492, -25);
  else
    WOWTR_Panel6Header1:SetPoint("TOPLEFT", parent, "TOPLEFT", 20, -25);
  end
  ...
  local WOWTR_CheckButton61 = CreateFrame("CheckButton", "WOWTR_CheckButton61", parent,
  ...
  local WOWTR_CheckButton62 = CreateFrame("CheckButton", "WOWTR_CheckButton62", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton63 = CreateFrame("CheckButton", "WOWTR_CheckButton63", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton64 = CreateFrame("CheckButton", "WOWTR_CheckButton64", parent,
    "UICheckButtonTemplate");
  ...
  if (ST_TooltipsID) then
    local WOWTR_CheckButton6A = CreateFrame("CheckButton", "WOWTR_CheckButton6A", parent,
      "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton65 = CreateFrame("CheckButton", "WOWTR_CheckButton65", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton66 = CreateFrame("CheckButton", "WOWTR_CheckButton66", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton67 = CreateFrame("CheckButton", "WOWTR_CheckButton67", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_Panel6Header2 = parent:CreateFontString(nil, "ARTWORK");
  ...
  if (WoWTR_Localization.lang == 'AR') then
    WOWTR_Panel6Header2:SetPoint("TOPLEFT", parent, "TOPLEFT", 560, -330);
  else
    WOWTR_Panel6Header2:SetPoint("TOPLEFT", parent, "TOPLEFT", 20, -330);
  end
  ...
  local WOWTR_CheckButton68 = CreateFrame("CheckButton", "WOWTR_CheckButton68", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_slider3 = CreateFrame("Slider", "WOWTR_slider3", parent, "OptionsSliderTemplate");
  if (WoWTR_Localization.lang == 'AR') then
  ...
  WOWTR_sliderVal3 = parent:CreateFontString(nil, "ARTWORK");
  ...
  local WOWTR_Panel6Header3 = parent:CreateFontString(nil, "ARTWORK");
  ...
  if (WoWTR_Localization.lang == 'AR') then
    WOWTR_Panel6Header3:SetPoint("TOPLEFT", parent, "TOPLEFT", 587, -460);
  else
    WOWTR_Panel6Header3:SetPoint("TOPLEFT", parent, "TOPLEFT", 20, -460);
  end
  ...
  local WOWTR_CheckButton69 = CreateFrame("CheckButton", "WOWTR_CheckButton69", parent,
    "UICheckButtonTemplate");
...
function WOWTR_UpdateTooltipsTab()
