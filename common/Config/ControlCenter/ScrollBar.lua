-- common/Config/ControlCenter/ScrollBar.lua
-- Ported from Plumber (Docs/Plumber/Modules/ControlCenter/ScrollBar.lua).
-- Namespaced under WOWTR.Config.ControlCenter to avoid collisions with the Plumber addon.
...
local function CreateScrollBarWithDynamicSize(parent)
    local f = CreateFrame("Frame", nil, parent, "WOWTR_ScrollBarWithDynamicSizeTemplate");

    Mixin(f, ScrollBarMixin);
    f:OnLoad();
    f:SetTexure(ControlCenter.Assets.ControlCenterWidget);
