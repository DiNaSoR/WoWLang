function WOWTR_CreateQuestsTab(parent)
  local WOWTR_OptionsHeaderIcon1 = parent:CreateTexture(nil, "OVERLAY");
  WOWTR_OptionsHeaderIcon1:SetWidth(200);
  WOWTR_OptionsHeaderIcon1:SetHeight(200);
  WOWTR_OptionsHeaderIcon1:SetTexture(WoWTR_Localization.mainFolder .. "\\Images\\quests_mini.jpg"); -- parent thumbnail
  ...
  local WOWTR_Panel1Header1 = parent:CreateFontString(nil, "ARTWORK");
  ...
  if (WoWTR_Localization.lang == 'AR') then
    WOWTR_Panel1Header1:SetPoint("TOPLEFT", parent, "TOPLEFT", 525, -25);
  else
    WOWTR_Panel1Header1:SetPoint("TOPLEFT", parent, "TOPLEFT", 20, -25);
  end

  local WOWTR_CheckButton11 = CreateFrame("CheckButton", "WOWTR_CheckButton11", parent,
  ...
  local WOWTR_CheckButton12 = CreateFrame("CheckButton", "WOWTR_CheckButton12", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton13 = CreateFrame("CheckButton", "WOWTR_CheckButton13", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton1a = CreateFrame("CheckButton", "WOWTR_CheckButton1a", parent,
    "UICheckButtonTemplate");
  ...
  -- QUEST TRACKER
  local WOWTR_CheckButton14 = CreateFrame("CheckButton", "WOWTR_CheckButton14", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_slider4 = CreateFrame("Slider", "WOWTR_slider4", parent, "OptionsSliderTemplate");
  if (WoWTR_Localization.lang == 'AR') then
  ...
  WOWTR_sliderVal4 = parent:CreateFontString(nil, "ARTWORK");
  ...
  WOWTR_Opis4 = parent:CreateFontString(nil, "ARTWORK");
  ...
  local WOWTR_CheckButton1c = CreateFrame("CheckButton", "WOWTR_CheckButton1c", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_Panel1Header2 = parent:CreateFontString(nil, "ARTWORK");
  ...
  if (WoWTR_Localization.lang == 'AR') then
    WOWTR_Panel1Header2:SetPoint("TOPLEFT", parent, "TOPLEFT", 580, -290);
  else
    WOWTR_Panel1Header2:SetPoint("TOPLEFT", parent, "TOPLEFT", 20, -290);
  end
  ...
  local WOWTR_CheckButton15 = CreateFrame("CheckButton", "WOWTR_CheckButton15", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton16 = CreateFrame("CheckButton", "WOWTR_CheckButton16", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_Panel1Header3 = parent:CreateFontString(nil, "ARTWORK");
  ...
  if (WoWTR_Localization.lang == 'AR') then
    WOWTR_Panel1Header3:SetPoint("TOPLEFT", parent, "TOPLEFT", 620, -390);
  else
    WOWTR_Panel1Header3:SetPoint("TOPLEFT", parent, "TOPLEFT", 20, -400);
  end
  ...
  local WOWTR_CheckButton17 = CreateFrame("CheckButton", "WOWTR_CheckButton17", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton18 = CreateFrame("CheckButton", "WOWTR_CheckButton18", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton19 = CreateFrame("CheckButton", "WOWTR_CheckButton19", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton1b = CreateFrame("CheckButton", "WOWTR_CheckButton1b", parent,
    "UICheckButtonTemplate");
...
function WOWTR_UpdateQuestsTab()
