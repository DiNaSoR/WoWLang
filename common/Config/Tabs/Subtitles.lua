-- Tab 3: Subtitles (Movies, Cinematics) and AR Chat section
-------------------------------------------------------------------------------------------------------

function WOWTR_BuildTab3()
  ...
  WOWTR_OptionsHeaderIcon3:SetTexture(WoWTR_Localization.mainFolder .. "\\Images\\movies_mini.jpg");
  ...
  WOWTR_Panel3Header1:SetText(QTR_ReverseIfAR(WoWTR_Config_Interface.generalMainHeaderMF));
  ...
  WOWTR_CheckButton31.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.activateSubtitleTranslations) .. "|r");
  ...
  WOWTR_CheckButton31:SetScript("OnEnter", function(self)
    ...
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.activateSubtitleTranslations) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.activateSubtitleTranslationsDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton31:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_CheckButton32.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.subtitleIntro) .. "|r");
  WOWTR_CheckButton32.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton32:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT"); GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.subtitleIntro) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.subtitleIntroDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton32:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_CheckButton33.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.subtitleMovies) .. "|r");
  WOWTR_CheckButton33.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton33:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT"); GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.subtitleMovies) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.subtitleMoviesDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton33:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_CheckButton34.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.subtitleCinematics) .. "|r");
  WOWTR_CheckButton34.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton34:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT"); GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.subtitleCinematics) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.subtitleCinematicsDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton34:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_Panel3Header2:SetText(QTR_ReverseIfAR(WoWTR_Config_Interface.savingUntranslatedSubtitles));
  ...
  WOWTR_CheckButton35.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.saveUntranslatedSubtitles) .. "|r");
  WOWTR_CheckButton35.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton35:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT"); GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.saveUntranslatedSubtitles) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.saveUntranslatedSubtitlesDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton35:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  if (WoWTR_Localization.lang == 'AR') then
    ...
    WOWTR_OptionsHeaderIcon8:SetWidth(200); WOWTR_OptionsHeaderIcon8:SetHeight(200);
    ...
    WOWTR_CheckButton36:SetScript("OnClick", function(self)
      if (CH_PM["active"] == "1") then CH_PM["active"] = "0"; CH_ToggleButton:SetText("EN"); CH_ToggleButton:Hide() else CH_PM["active"] = "1"; CH_ToggleButton:Show() end;
    end);
    ...
    WOWTR_CheckButton36.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.activateChatService) .. "|r");
    WOWTR_CheckButton36.Text:SetFont(WOWTR_Font2, 15);
    WOWTR_CheckButton36:SetScript("OnEnter", function(self)
      GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT"); GameTooltip:ClearLines();
      GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.activateChatService) .. NONBREAKINGSPACE, false);
      getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
      GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.activateChatServiceDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
      getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
      GameTooltip:Show();
    end);
    WOWTR_CheckButton36:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
    ...
    WOWTR_CheckButton37.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.chatFontActivate) .. "|r");
    WOWTR_CheckButton37.Text:SetFont(WOWTR_Font2, 15);
    WOWTR_CheckButton37:SetScript("OnEnter", function(self)
      GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT"); GameTooltip:ClearLines();
      GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.chatFontActivate) .. NONBREAKINGSPACE, false);
      getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
      GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.chatFontActivateDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
      getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
      GameTooltip:Show();
    end);
    WOWTR_CheckButton37:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
    ...
    WOWTR_slider6.Low:SetText(WOWTR_slider6.minValue); WOWTR_slider6.High:SetText(WOWTR_slider6.maxValue);
    ...
    if CH_PM and CH_PM["fontsize"] then local fontsize = tonumber(CH_PM["fontsize"]) if fontsize then WOWTR_slider6:SetValue(fontsize) else WOWTR_slider6:SetValue(13) end else WOWTR_slider6:SetValue(13) end
    ...
    WOWTR_sliderVal6:SetFontObject(GameFontNormal); WOWTR_sliderVal6:SetJustifyH("CENTER"); WOWTR_sliderVal6:SetJustifyV("TOP");
    WOWTR_sliderVal6:ClearAllPoints(); WOWTR_sliderVal6:SetPoint("CENTER", WOWTR_slider6, "CENTER", 0, -12);
    WOWTR_sliderVal6:SetText(BB_PM["fontsize"]); WOWTR_sliderVal6:SetFont(WOWTR_Font2, 13);
  end
end
