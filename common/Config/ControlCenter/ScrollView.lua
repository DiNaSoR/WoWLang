-- common/Config/ControlCenter/ScrollView.lua
-- Ported from Plumber (Docs/Plumber/Modules/ExpansionLandingPage/ScrollView.lua).
...
do
    ...
    function CreateScrollBar(parent)
        local textureFile = CC.Assets.ExpansionBorderTWW;
