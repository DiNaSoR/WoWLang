...
function WOWTR_BuildTab2()
  ...
  WOWTR_OptionsHeaderIcon2:SetTexture(WoWTR_Localization.mainFolder .. "\\Images\\bubbles_mini.jpg");
  ...
  WOWTR_Panel2Header1:SetText(QTR_ReverseIfAR(WoWTR_Config_Interface.generalMainHeaderBB));
  ...
  WOWTR_CheckButton21.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.activateBubblesTranslations) .. "|r");
  WOWTR_CheckButton21.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton21:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.activateBubblesTranslations) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.activateBubblesTranslationsDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton21:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_CheckButton22.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.displayOriginalTexts) .. "|r");
  WOWTR_CheckButton22.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton22:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.displayOriginalTexts) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.displayOriginalTextsDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton22:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_CheckButton23.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.displayTranslatedTexts) .. "|r");
  WOWTR_CheckButton23.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton23:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.displayTranslatedTexts) .. NONBREAKINGSPACE, false);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.displayTranslatedTextsDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show()
  end);
  WOWTR_CheckButton23:SetScript("OnLeave", function(self) GameTooltip:Hide() end);

  local WOWTR_CheckButton24 = CreateFrame("CheckButton", "WOWTR_CheckButton24", WOWTR_OptionPanel2, "UICheckButtonTemplate");
  WOWTR_CheckButton24:SetScript("OnClick", function(self)
    if (BB_PM["sex"] == "2") then BB_PM["sex"] = "4"; WOWTR_CheckButton26:SetChecked(true) else BB_PM["sex"] = "2"; WOWTR_CheckButton25:SetChecked(false); WOWTR_CheckButton26:SetChecked(false) end;
  end);
  ...
  WOWTR_CheckButton24.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.choiceGender1OfPlayer) .. "|r");
  WOWTR_CheckButton24.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton24:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.choiceGender1OfPlayer) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.choiceGender1OfPlayerDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton24:SetScript("OnLeave", function(self) GameTooltip:Hide() end);

  local WOWTR_CheckButton25 = CreateFrame("CheckButton", "WOWTR_CheckButton25", WOWTR_OptionPanel2, "UICheckButtonTemplate");
  WOWTR_CheckButton25:SetScript("OnClick", function(self)
    if (BB_PM["sex"] == "3") then BB_PM["sex"] = "4"; WOWTR_CheckButton26:SetChecked(true) else BB_PM["sex"] = "3"; WOWTR_CheckButton24:SetChecked(false); WOWTR_CheckButton26:SetChecked(false) end;
  end);
  ...
  WOWTR_CheckButton25.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.choiceGender2OfPlayer) .. "|r");
  WOWTR_CheckButton25.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton25:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.choiceGender2OfPlayer) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.choiceGender2OfPlayerDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton25:SetScript("OnLeave", function(self) GameTooltip:Hide() end);

  local WOWTR_CheckButton26 = CreateFrame("CheckButton", "WOWTR_CheckButton26", WOWTR_OptionPanel2, "UICheckButtonTemplate");
  WOWTR_CheckButton26:SetScript("OnClick", function(self)
    if (BB_PM["sex"] == "4") then BB_PM["sex"] = "2"; WOWTR_CheckButton24:SetChecked(true) else BB_PM["sex"] = "4"; WOWTR_CheckButton24:SetChecked(false); WOWTR_CheckButton25:SetChecked(false) end;
  end);
  ...
  WOWTR_CheckButton26.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.choiceGender3OfPlayer) .. "|r");
  WOWTR_CheckButton26.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton26:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.choiceGender3OfPlayer) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.choiceGender3OfPlayerDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton26:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_CheckButton2d1.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.showBubblesInDungeon) .. "|r");
  ...
  WOWTR_CheckButton2d1:SetScript("OnEnter", function(self)
    ...
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.showBubblesInDungeon) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.showBubblesInDungeonDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton2d1:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_CheckButton2d2:SetScript("OnClick", function(self)
    if (BB_PM["dungeonF"] == "1") then
      BB_PM["dungeonF"] = "0";
      WOWTR_SetDungeonFrames(WOWBB1, false); WOWTR_SetDungeonFrames(WOWBB2, false); WOWTR_SetDungeonFrames(WOWBB3, false); WOWTR_SetDungeonFrames(WOWBB4, false); WOWTR_SetDungeonFrames(WOWBB5, false);
    else
      BB_PM["dungeonF"] = "1";
      WOWTR_SetDungeonFrames(WOWBB1, true, 0); WOWTR_SetDungeonFrames(WOWBB2, true, 250); WOWTR_SetDungeonFrames(WOWBB3, true, -250); WOWTR_SetDungeonFrames(WOWBB4, true, 500); WOWTR_SetDungeonFrames(WOWBB5, true, -500);
    end
  end);
  if (WoWTR_Localization.lang == 'AR') then
  ...
  WOWTR_CheckButton2d2.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.setDungeonFrames) .. "|r");
  WOWTR_CheckButton2d2.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton2d2:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT"); GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.setDungeonFrames) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.setDungeonFramesDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton2d2:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_Panel2Header2:SetText(QTR_ReverseIfAR(WoWTR_Config_Interface.savingUntranslatedBubbles));
  ...
  WOWTR_CheckButton27.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.saveUntranslatedBubbles) .. "|r");
  WOWTR_CheckButton27.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton27:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.saveUntranslatedBubbles) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.saveUntranslatedBubblesDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton27:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_Panel2Header3:SetText(QTR_ReverseIfAR(WoWTR_Config_Interface.fontSizeHeader));
  ...
  WOWTR_CheckButton28.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.setFontActivate) .. "|r");
  ...
  WOWTR_CheckButton28:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
