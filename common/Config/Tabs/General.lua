-- Tab 1: General / Quests
-------------------------------------------------------------------------------------------------------

function WOWTR_BuildTab1()
  ...
  WOWTR_OptionsHeaderIcon1:SetTexture(WoWTR_Localization.mainFolder .. "\\Images\\quests_mini.jpg");
  ...
  WOWTR_Panel1Header1:SetText(QTR_ReverseIfAR(WoWTR_Config_Interface.generalMainHeaderQS));
  ...
  WOWTR_CheckButton11.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.activateQuestsTranslations) .. "|r");
  WOWTR_CheckButton11.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton11:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT");
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.activateQuestsTranslations) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.activateQuestsTranslationsDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton11:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_CheckButton12.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.translateQuestTitles) .. "|r");
  WOWTR_CheckButton12.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton12:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.translateQuestTitles) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.translateQuestTitlesDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton12:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_CheckButton13.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.translateGossipTexts) .. "|r");
  WOWTR_CheckButton13.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton13:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.translateGossipTexts) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.translateGossipTextsDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton13:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  if (WoWTR_Localization.lang == 'AR') then
    WOWTR_CheckButton1a.Text:SetText(QTR_ReverseIfAR(WOW_ZmienKody(WoWTR_Config_Interface.translateOwnNames) .. ""));
  else
    WOWTR_CheckButton1a.Text:SetText(QTR_ReverseIfAR(WoWTR_Config_Interface.translateOwnNames));
  end
  ...
  WOWTR_CheckButton1a:SetScript("OnEnter", function(self)
    ...
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.translateOwnNamesDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton1a:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_CheckButton14.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.translateTrackObjectives) .. "|r");
  WOWTR_CheckButton14.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton14:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.translateTrackObjectives) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.translateTrackObjectivesDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton14:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  if (WoWTR_Localization.lang == 'AR') then WOWTR_CheckButton14:Hide(); end
  ...
  WOWTR_CheckButton1c.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.displayENfirst) .. "|r");
  WOWTR_CheckButton1c.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton1c:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.displayENfirst) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.displayENfirstDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton1c:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_Panel1Header2:SetText(QTR_ReverseIfAR(WoWTR_Config_Interface.savingUntranslatedQuests));
  ...
  WOWTR_CheckButton15.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.saveUntranslatedQuests) .. "|r");
  WOWTR_CheckButton15.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton15:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.saveUntranslatedQuests) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.saveUntranslatedQuestsDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton15:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_CheckButton16.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.saveUntranslatedGossip) .. "|r");
  WOWTR_CheckButton16.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton16:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.saveUntranslatedGossip) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.saveUntranslatedGossipDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton16:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_Panel1Header3:SetText(QTR_ReverseIfAR(WoWTR_Config_Interface.integrationWithOtherAddons));
  ...
  WOWTR_CheckButton17.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.translateImmersion) .. "|r");
  WOWTR_CheckButton17.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton17:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.translateImmersion) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.translateImmersionDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton17:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_CheckButton18.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.translateStoryLine) .. "|r");
  WOWTR_CheckButton18.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton18:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.translateStoryLine) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.translateStoryLineDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton18:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_CheckButton19.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.translateQuestLog) .. "|r");
  WOWTR_CheckButton19.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton19:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.translateQuestLog) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.translateQuestLogDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton19:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
  ...
  WOWTR_CheckButton1b.Text:SetText("|cffffffff" .. QTR_ReverseIfAR(WoWTR_Config_Interface.translateDialogueUI) .. "|r");
  WOWTR_CheckButton1b.Text:SetFont(WOWTR_Font2, 15);
  WOWTR_CheckButton1b:SetScript("OnEnter", function(self)
    GameTooltip:SetOwner(self, "ANCHOR_CURSOR_RIGHT")
    GameTooltip:ClearLines();
    GameTooltip:AddLine(QTR_ReverseIfAR(WoWTR_Config_Interface.translateDialogueUI) .. NONBREAKINGSPACE, false);
    getglobal("GameTooltipTextLeft1"):SetFont(WOWTR_Font2, 13);
    GameTooltip:AddLine(QTR_ExpandUnitInfo(WoWTR_Config_Interface.translateDialogueUIDESC, false, getglobal("GameTooltipTextLeft1"), WOWTR_Font2) .. NONBREAKINGSPACE, 1, 1, 1, true);
    getglobal("GameTooltipTextLeft2"):SetFont(WOWTR_Font2, 13);
    GameTooltip:Show();
  end);
  WOWTR_CheckButton1b:SetScript("OnLeave", function(self) GameTooltip:Hide() end);
end
