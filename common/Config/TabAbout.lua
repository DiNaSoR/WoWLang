function WOWTR_CreateAboutTab(parent)
  local WOWTR_Panel9Text = parent:CreateFontString(nil, "ARTWORK");
  ...
  WOWTR_Panel9Text:SetPoint("TOPLEFT", parent, "TOPLEFT", 25, -10);
  ...
  local WOWTR_Panel9Header1 = parent:CreateFontString(nil, "ARTWORK");
  ...
  local WOWTR_Panel9Author1 = parent:CreateFontString(nil, "ARTWORK");
  ...
  local WOWTR_Panel9Author2 = parent:CreateFontString(nil, "ARTWORK");
  ...
  local WOWTR_Panel9Email1 = parent:CreateFontString(nil, "ARTWORK");
  ...
  local WOWTR_Panel9Email2 = parent:CreateFontString(nil, "ARTWORK");
  ...
  if (WoWTR_Localization.lang == 'TR') then
    ...
    local WOWTR_Panel9Email3 = parent:CreateFontString(nil, "ARTWORK");
  ...
  WOWTR_ResetButton1 = CreateFrame("BUTTON", nil, parent, "UIPanelButtonTemplate");
  ...
  local WOWTR_Panel9Header2 = parent:CreateFontString(nil, "ARTWORK");
  ...
  local WOWTR_Panel9TextContact = parent:CreateFontString(nil, "ARTWORK");
  ...
  WOWTR_LinkFrame = CreateFrame("Frame", nil, parent, "UIPanelDialogTemplate");
  ...
  if (string.len(WoWTR_Localization.addressWWW) > 1) then
    local WOWTR_linkButtonWWW = CreateFrame("Button", nil, parent)
  ...
  if (string.len(WoWTR_Localization.addressDiscord) > 1) then
    local WOWTR_linkButtonDISC = CreateFrame("Button", nil, parent)
  ...
  if (string.len(WoWTR_Localization.addressTwitch) > 1) then
    local WOWTR_linkButtonTWITCH = CreateFrame("Button", nil, parent)
  ...
  if (string.len(WoWTR_Localization.addressFanPage) > 1) then
    local WOWTR_linkButtonFB = CreateFrame("Button", nil, parent)
  ...
  if (string.len(WoWTR_Localization.addressEmail) > 1) then
    local WOWTR_linkButtonEMAIL = CreateFrame("Button", nil, parent)
  ...
  if (string.len(WoWTR_Localization.addressCurse) > 1) then
    local WOWTR_linkButtonCURSE = CreateFrame("Button", nil, parent)
  ...
  if (string.len(WoWTR_Localization.addressPayPal) > 1) then
    local WOWTR_linkButtonPP = CreateFrame("Button", nil, parent)
  ...
  if (string.len(WoWTR_Localization.addressBlik) > 1) then
    local WOWTR_linkButtonBLIK = CreateFrame("Button", nil, parent)
    if (WoWTR_Localization.lang == 'TR') then
  ...
  local WOWTR_Panel9Header3 = parent:CreateFontString(nil, "ARTWORK");
  ...
  local WOWTR_Panel9Testers = parent:CreateFontString(nil, "ARTWORK");
  ...
  if (string.len(WoWTR_Config_Interface.welcomeText) > 1) then
    local WOWTR_ShowWelcomePanel = CreateFrame("BUTTON", nil, parent, "UIPanelButtonTemplate");
