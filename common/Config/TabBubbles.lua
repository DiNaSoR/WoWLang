function WOWTR_CreateBubblesTab(parent)
  local WOWTR_OptionsHeaderIcon2 = parent:CreateTexture(nil, "OVERLAY");
  WOWTR_OptionsHeaderIcon2:SetWidth(200);
  WOWTR_OptionsHeaderIcon2:SetHeight(200);
  WOWTR_OptionsHeaderIcon2:SetTexture(WoWTR_Localization.mainFolder .. "\\Images\\bubbles_mini.jpg"); -- parent thumbnail
  ...
  local WOWTR_Panel2Header1 = parent:CreateFontString(nil, "ARTWORK");
  ...
  if (WoWTR_Localization.lang == 'AR') then
    WOWTR_Panel2Header1:SetPoint("TOPLEFT", parent, "TOPLEFT", 500, -25);
  else
    WOWTR_Panel2Header1:SetPoint("TOPLEFT", parent, "TOPLEFT", 20, -25);
  end
  ...
  local WOWTR_CheckButton21 = CreateFrame("CheckButton", "WOWTR_CheckButton21", parent,
  ...
  local WOWTR_CheckButton22 = CreateFrame("CheckButton", "WOWTR_CheckButton22", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton23 = CreateFrame("CheckButton", "WOWTR_CheckButton23", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton24 = CreateFrame("CheckButton", "WOWTR_CheckButton24", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton25 = CreateFrame("CheckButton", "WOWTR_CheckButton25", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton26 = CreateFrame("CheckButton", "WOWTR_CheckButton26", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton2d1 = CreateFrame("CheckButton", "WOWTR_CheckButton2d1", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_CheckButton2d2 = CreateFrame("CheckButton", "WOWTR_CheckButton2d2", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_slider5 = CreateFrame("Slider", "WOWTR_slider5", parent, "OptionsSliderTemplate");
  if (WoWTR_Localization.lang == 'AR') then
  ...
  WOWTR_sliderVal5 = parent:CreateFontString(nil, "ARTWORK");
  ...
  local WOWTR_Panel2Header2 = parent:CreateFontString(nil, "ARTWORK");
  ...
  if (WoWTR_Localization.lang == 'AR') then
    WOWTR_Panel2Header2:SetPoint("TOPLEFT", parent, "TOPLEFT", 579, -290);
  else
    WOWTR_Panel2Header2:SetPoint("TOPLEFT", parent, "TOPLEFT", 20, -290);
  end
  ...
  local WOWTR_CheckButton27 = CreateFrame("CheckButton", "WOWTR_CheckButton27", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_Panel2Header3 = parent:CreateFontString(nil, "ARTWORK");
  ...
  if (WoWTR_Localization.lang == 'AR') then
    WOWTR_Panel2Header3:SetPoint("TOPLEFT", parent, "TOPLEFT", 600, -370);
  else
    WOWTR_Panel2Header3:SetPoint("TOPLEFT", parent, "TOPLEFT", 20, -370);
  end
  ...
  local WOWTR_CheckButton28 = CreateFrame("CheckButton", "WOWTR_CheckButton28", parent,
    "UICheckButtonTemplate");
  ...
  local WOWTR_slider1 = CreateFrame("Slider", "WOWTR_slider1", parent, "OptionsSliderTemplate");
  if (WoWTR_Localization.lang == 'AR') then
  ...
  WOWTR_sliderVal1 = parent:CreateFontString(nil, "ARTWORK");
  ...
  WOWTR_Opis1 = parent:CreateFontString(nil, "ARTWORK");
...
function WOWTR_UpdateBubblesTab()
  ...
  if WOWTR_slider1 then
    WOWTR_slider1:SetValue(tonumber(BB_PM["fontsize"]));
  end
  if WOWTR_slider5 then
    WOWTR_slider5:SetValue(tonumber(BB_PM["timeDisplay"]));
  end
end
