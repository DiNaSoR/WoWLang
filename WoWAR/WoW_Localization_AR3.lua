...
WoWTR_Config_Interface = {
   ...
   showMinimapIconDESC = "ملخص: يظهر أيقونة الإضافة بجانب الخريطة المصغرة.\nنصيحة: اضغط على الأيقونة لفتح الإعدادات بسرعة.",
   ...
   ControlCenter_UI_TalentsUI_DESC = "ملخص: يترجم واجهة المواهب.\nنصيحة: افتح المواهب مرة ثانية إذا لم تتحدث الترجمة.",
   ...
   activateQuestsTranslationsDESC = "ملخص: يترجم نصوص المهام والحوار إلى العربية.\nنصيحة: إذا وجدت نص غير مترجم فعّل خيار الحفظ لمساعدتنا.",
   translateQuestTitles = "ﻋﺮﺽ ﻋﻨﺎﻭﻳﻦ ﺍﻟﻤﻬﺎﻡ ﺑﺎﻟﻌﺮﺑﻴﺔ",
   translateQuestTitlesDESC = "ملخص: يترجم عناوين المهام فقط.\nنصيحة: أوقفه إذا تريد العنوان الأصلي.",
   translateGossipTexts = "ﻋﺮﺽ ﻧﺼﻮﺹ ﺍﻟﺤﻮﺍﺭﺍﺕ CPN ﺑﺎﻟﻌﺮﺑﻴﺔ",
   translateGossipTextsDESC = "ملخص: يترجم نصوص الحوار مع الشخصيات.\nنصيحة: أعد فتح نافذة الحوار إذا لم يتغير النص فوراً.",
   translateTrackObjectives = "ﻋﺮﺽ ﺗﺮﺟﻤﺔ ﻗﺎﺋﻤﺔ ﺗﺘﺒﻊ ﺍﻟﻤﻬﺎﻡ ﺑﺎﻟﻌﺮﺑﻴﺔ",
   translateTrackObjectivesDESC = "ملخص: يترجم قائمة تتبع المهام.\nنصيحة: مفيد عندما تتابع أكثر من مهمة.",
   translateOwnNames = "ﻋﺮﺽ ﺃﺳﻤﺎﺀ ﺍﻷﻣﺎﻛﻦ ﺑﺎﻟﻌﺮﺑﻴﺔ - 002DFFFFc|)ﻏﻴﺮ ﻧﺸﻂ ﺍﻵﻥ(r|",
   translateOwnNamesDESC = "ملخص: يترجم بعض أسماء الأماكن (تجريبي).\nنصيحة: قد لا يعمل لكل الأسماء.",
   savingUntranslatedQuests = "ﺧﻴﺎﺭﺍﺕ ﺍﻟﺤﻔﻆ",
   saveUntranslatedQuests = "ﺣﻔﻆ ﺍﻟﻤﻬﺎﻡ ﻏﻴﺮ ﺍﻟﻤﺘﺮﺟﻤﺔ",
   saveUntranslatedQuestsDESC = "ملخص: يحفظ أسطر المهام غير المترجمة في ملف الحفظ.\nنصيحة: شارك ملف الحفظ معنا لنضيف الترجمة.",
   saveUntranslatedGossip = "ﺣﻔﻆ ﺣﻮﺍﺭﺍﺕ CPN ﻏﻴﺮ ﺍﻟﻤﺘﺮﺟﻤﺔ",
   saveUntranslatedGossipDESC = "ملخص: يحفظ أسطر الحوارات غير المترجمة في ملف الحفظ.\nنصيحة: شارك ملف الحفظ معنا لنضيف الترجمة.",
   integrationWithOtherAddons = "ﺍﻟﺘﻜﺎﻣﻞ",
   translateImmersion = "ﻋﺮﺽ ﺍﻟﺘﺮﺟﻤﺎﺕ ﻓﻲ ﺇﺿﺎﻓﺔ noisremmI",
   translateImmersionDESC = "ملخص: يفعّل الترجمة داخل إضافة noisremmI.\nنصيحة: فعّله فقط إذا كنت تستخدم هذه الإضافة.",
   translateStoryLine = "ﻋﺮﺽ ﺍﻟﺘﺮﺟﻤﺎﺕ ﻓﻲ ﺇﺿﺎﻓﺔ eniLyrotS",
   translateStoryLineDESC = "ملخص: يفعّل الترجمة داخل إضافة eniLyrotS.\nنصيحة: فعّله فقط إذا كنت تستخدم هذه الإضافة.",
   translateQuestLog = "ﻋﺮﺽ ﺍﻟﺘﺮﺟﻤﺎﺕ ﻓﻲ ﺇﺿﺎﻓﺔ goL tseuQ cissalC",
   translateQuestLogDESC = "ملخص: يفعّل الترجمة داخل إضافة goL tseuQ cissalC.\nنصيحة: فعّله فقط إذا كنت تستخدم هذه الإضافة.",
   translateDialogueUI = "ﻋﺮﺽ ﺍﻟﺘﺮﺟﻤﺎﺕ ﻓﻲ ﺇﺿﺎﻓﺔ IUeuqolaiD",
   translateDialogueUIDESC = "ملخص: يفعّل الترجمة داخل إضافة IUeuqolaiD.\nنصيحة: فعّله فقط إذا كنت تستخدم هذه الإضافة.",
   ...
   displayENfirstDESC = "ملخص: يعرض النص الإنجليزي قبل الترجمة.\nنصيحة: مفيد للمقارنة أو إذا كانت الترجمة ناقصة.", -- If enabled, English text will display first on Quests and Gossip

   titleTab2 = "ﺍﻟﻔﻘﺎﻋﺎﺕ",
   generalMainHeaderBB = "ﺗﺮﺟﻤﺎﺕ ﺍﻟﻔﻘﺎﻋﺎﺕ - selbbuB",
   activateBubblesTranslations = "ﺗﻔﻌﻴﻞ ﺗﺮﺟﻤﺎﺕ ﺍﻟﻔﻘﺎﻋﺎﺕ",
   activateBubblesTranslationsDESC = "ملخص: يترجم فقاعات الكلام فوق الشخصيات.\nنصيحة: إذا كان النص يتكرر في الشات، فعّل خيار واحد فقط (الأصل أو الترجمة).",
   displayOriginalTexts = "ﻋﺮﺽ ﺍﻟﻨﺺ ﺍﻷﺻﻠﻲ ﻓﻲ ﻧﺎﻓﺬﺓ ﺍﻟﺪﺭﺩﺷﺔ",
   displayOriginalTextsDESC = "ملخص: يعرض النص الأصلي في الشات مع الفقاعات.\nنصيحة: أوقفه إذا كنت تريد الشات مترجم فقط.",
   displayTranslatedTexts = "ﻋﺮﺽ ﺍﻟﺘﺮﺟﻤﺔ اﻟﻌﺮﺑﻴﺔ ﻓﻲ ﻧﺎﻓﺬﺓ ﺍﻟﺪﺭﺩﺷﺔ",
   displayTranslatedTextsDESC = "ملخص: يعرض الترجمة في الشات مع الفقاعات.\nنصيحة: فعّله بدل النص الأصلي لتجنب تكرار السطور.",
   ...
   choiceGender3OfPlayerDESC = "ملخص: يحدد طريقة التعامل مع الكلمات المذكرة/المؤنثة في الترجمة.\nنصيحة: اختر (حسب شخصيتك) ليتم الاختيار تلقائياً.",
   showBubblesInDungeon = "ﺇﻇﻬﺎﺭ ﻓﻘﺎﻋﺎﺕ ﺍﻟﻜﻼﻡ ﻓﻲ ﺍﻷﺑﺮﺍﺝ ﺍﻟﻤﺤﺼﻨﺔ",
   showBubblesInDungeonDESC = "ملخص: يعرض الفقاعات في الدهاليز كإطارات ثابتة.\nنصيحة: مفيد أثناء القتال عندما تختفي الفقاعات بسرعة.",
   ...
   saveUntranslatedBubblesDESC = "ملخص: يحفظ فقاعات الكلام غير المترجمة في ملف الحفظ.\nنصيحة: شارك ملف الحفظ معنا لنضيف الترجمة.",
   fontSizeHeader = "ﺣﺠﻢ ﺍﻟﺨﻂ",
   setFontActivate = "ﺗﻔﻌﻴﻞ ﺗﻐﻴﻴﺮ ﺣﺠﻢ ﺍﻟﺨﻂ",
   setFontActivateDESC = "ملخص: يسمح لك بتغيير حجم الخط.\nنصيحة: بعد التفعيل عدّل شريط حجم الخط حتى يناسبك.",
   fontsizeBubbles = "ﺍﺧﺘﺮ ﺣﺠﻢ ﺍﻟﺨﻂ",
   fontsizeBubblesDESC = "ملخص: يحدد حجم خط الفقاعات.\nنصيحة: اختر حجم أكبر إذا كان النص صغير.",
   sampleText = "ﻧﻤﻮﺫﺝ ﻧﺺ ﺣﺠﻢ ﺍﻟﺨﻂ",
   timerDisplay = "ﻭﻗﺖ ﻋﺮﺽ ﺍﻟﺘﺮﺟﻤﺔ",
   timerDisplayDESC = "ملخص: يحدد مدة بقاء إطار الفقاعة في الدهليز.\nنصيحة: وقت أقل يقلل الزحمة على الشاشة.",
   ...
   activateSubtitleTranslationsDESC = "ملخص: يعرض ترجمات المقاطع السينمائية.\nنصيحة: إذا لا تريد الترجمات أثناء المشاهدة، أوقف هذا الخيار.",
   subtitleIntro = "ﻋﺮﺽ ﺗﺮﺟﻤﺎﺕ ﺍﻟﻤﺸﺎﻫﺪ ﺍﻟﺘﻤﻬﻴﺪﻳﺔ",
   subtitleIntroDESC = "ملخص: يترجم مشاهد البداية.\nنصيحة: فعّله إذا تريد ترجمة كل المقاطع.",
   subtitleMovies = "ﻋﺮﺽ ﺗﺮﺟﻤﺎﺕ ﺍﻟﻤﺸﺎﻫﺪ ﺍﻟﺴﻴﻨﻤﺎﺋﻴﺔ",
   subtitleMoviesDESC = "ملخص: يترجم الأفلام داخل اللعبة.\nنصيحة: اتركه مفعّل إذا تريد الترجمة دائماً.",
   subtitleCinematics = "ﻋﺮﺽ ﺗﺮﺟﻤﺎﺕ ﺍﻟﻌﺮﻭﺽ ﺍﻟﺴﻴﻨﻤﺎﺋﻴﺔ",
   subtitleCinematicsDESC = "ملخص: يترجم السينمائيات.\nنصيحة: أوقفه إذا كان يسبب لك تقطيع أو إزعاج.",
   savingUntranslatedSubtitles = "ﺧﻴﺎﺭﺍﺕ ﺍﻟﺤﻔﻆ",
   saveUntranslatedSubtitles = "ﺣﻔﻆ ﺍﻟﺘﺮﺟﻤﺎﺕ ﻏﻴﺮ ﺍﻟﻤﺘﺮﺟﻤﺔ",
   saveUntranslatedSubtitlesDESC = "ملخص: يحفظ سطور الترجمات غير المتوفرة في ملف الحفظ.\nنصيحة: شارك ملف الحفظ معنا لنضيف الترجمة.",
   chatService = "اﻟﻜﺘﺎﺑﺔ ﺑﺎﻟﻠﻐﺔ اﻟﻌﺮﺑﻴﺔ ﻓﻲ اﻟﺸﺎت - tahC",
   activateChatService = "ﺗﻔﻌﻴﻞ ﺧﺎﺻﻴﺔ اﻟﻜﺘﺎﺑﺔ ﺑﺎﻟﻠﻐﺔ اﻟﻌﺮﺑﻴﺔ",
   activateChatServiceDESC = "ملخص: يسمح لك بالكتابة بالعربية في الشات بسهولة.\nنصيحة: استخدمه عندما تكتب رسائل عربية كثيرة.",
   chatFontActivate = "ﺗﻔﻌﻴﻞ ﺗﻐﻴﻴﺮ ﺣﺠﻢ ﺍﻟﺨﻂ",
   chatFontActivateDESC = "ملخص: يفعّل تغيير حجم خط الشات العربي.\nنصيحة: عدّل حجم الخط إذا كانت الحروف كبيرة أو صغيرة.",
   fontsizeChat = "ﺍﺧﺘﺮ ﺣﺠﻢ ﺍﻟﺨﻂ",
   fontsizeChatDESC = "ملخص: يحدد حجم خط الشات العربي.\nنصيحة: حجم أكبر يساعد على القراءة.",
   ...
   saveUntranslatedTutorialsDESC = "ملخص: يحفظ نصوص الدروس التعليمية غير المترجمة في ملف الحفظ.\nنصيحة: شارك ملف الحفظ معنا لنضيف الترجمة.",
   fontSelectingFontHeader = "ﺗﺤﺪﻳﺪ ﺍﻟﺨﻂ ﺍﻹﺿﺎﻓﻲ", -- Selecting the add-on font
   fontSelectingFontHeaderDESC = "ملخص: يغير الخط المستخدم في الترجمة.\nنصيحة: اختر خط يدعم العربية بشكل واضح.",
   fontSelectFontFile = "Select a font file", -- Select a font file
   fontCurrentFont = "ﺍﻟﺨﻂ ﺍﻟﺤﺎﻟﻲ:", -- Current font:
   fontsize = "ﺣﺠﻢ ﺍﻟﺨﻂ",
   fontsizeDESC = "ملخص: يغير حجم الخط في الترجمة.\nنصيحة: حجم أكبر يساعد على القراءة.",
   ...
   saveTranslationUIDESC = "ملخص: يحفظ نصوص الواجهة غير المترجمة.\nنصيحة: فعّله إذا لاحظت أزرار أو قوائم ما زالت إنجليزية.",
   ...
   displayTranslationUI1DESC = "ملخص: يترجم قائمة اللعبة.\nنصيحة: أوقفه إذا تريد قائمة اللعبة كما هي.",
   displayTranslationUI2 = "ﻣﻌﻠﻮﻣﺎﺕ ﺍﻟﺸﺨﺼﻴﺔ",
   displayTranslationUI2DESC = "ملخص: يترجم واجهة معلومات الشخصية.\nنصيحة: أوقفه إذا تريد الأسماء الأصلية للأغراض في هذه النافذة.",
   displayTranslationUI3 = "ﺍﻟﺒﺤﺚ ﻋﻦ ﻣﺠﻤﻮﻋﺔ",
   displayTranslationUI3DESC = "ملخص: يترجم واجهة البحث عن مجموعة.\nنصيحة: مفيد إذا كنت تبحث عن دنجن/رايد باللغة العربية.",
   displayTranslationUI4 = "ﺍﻟﻤﺠﻤﻮﻋﺎﺕ",
   displayTranslationUI4DESC = "ملخص: يترجم صفحة المجموعات.\nنصيحة: أوقفه إذا كنت تفضل أسماء الإنجليزي للأشياء/المقتنيات.",
   displayTranslationUI5 = "ﺩﻟﻴﻞ ﺍﻟﻤﻐﺎﻣﺮﺍﺕ",
   displayTranslationUI5DESC = "ملخص: يترجم دليل المغامر وصفحاته.\nنصيحة: مفيد لقراءة شرح البوسات بالعربية.",
   displayTranslationUI6 = "ﻗﺎﺋﻤﺔ ﺍﻷﺻﺪﻗﺎﺀ",
   displayTranslationUI6DESC = "ملخص: يترجم قائمة الأصدقاء.\nنصيحة: أوقفه إذا كنت لا تحتاج ترجمة هذه القائمة.",
   displayTranslationUI7 = "ﺍﻟﻤﻬﻦ ﺍﻟﻤﻬﻦ",
   displayTranslationUI7DESC = "ملخص: يترجم واجهة المهن ومحتوياتها.\nنصيحة: مفيد أثناء التعلم أو صناعة الأدوات.",
   displayTranslationUI8 = "ﺍﻟﻔﻠﺘﺮ ﻭﺍﻟﻘﻮﺍﺋﻢ ﺍﻟﻤﻨﺴﺪﻟﺔ",
   displayTranslationUI8DESC = "ملخص: يترجم الفلاتر والقوائم المنسدلة.\nنصيحة: أوقفه إذا لاحظت تعارض مع إضافات تغير القوائم.",

   titleTab5 = "ﺍﻟﻜﺘﺐ",
   generalMainHeaderBT = "ﺗﺮﺟﻤﺎﺕ ﺍﻟﻜﺘﺐ - skooB",
   activateBooksTranslations = "ﺗﻔﻌﻴﻞ ﺗﺮﺟﻤﺎﺕ ﺍﻟﻜﺘﺐ",
   activateBooksTranslationsDESC = "ملخص: يترجم الكتب والرسائل داخل اللعبة.\nنصيحة: إذا وجدت كتاب غير مترجم فعّل خيار الحفظ.",
   translateBookTitles = "ﻋﺮﺽ ﺗﺮﺟﻤﺎﺕ ﻋﻨﺎﻭﻳﻦ ﺍﻟﻜﺘﺐ",
   translateBookTitlesDESC = "ملخص: يترجم عنوان الكتاب.\nنصيحة: أوقفه إذا تريد العنوان الأصلي.",
   showBookID = "ﻋﺮﺽ ﻣﻌﺮﻑ ﺍﻟﻜﺘﺎﺏ",
   showBookIDDESC = "ملخص: يعرض رقم معرف الكتاب.\nنصيحة: مفيد عند الإبلاغ عن كتاب غير مترجم.",
   savingUntranslatedBooks = "ﺧﻴﺎﺭﺍﺕ ﺍﻟﺤﻔﻆ",
   saveUntranslatedBooks = "ﺣﻔﻆ ﺍﻟﻜﺘﺐ ﻏﻴﺮ ﺍﻟﻤﺘﺮﺟﻤﺔ",
   saveUntranslatedBooksDESC = "ملخص: يحفظ الكتب غير المترجمة في ملف الحفظ.\nنصيحة: شارك ملف الحفظ معنا لنضيف الترجمة.",

   titleTab6 = "ﺍﻟﺘﻠﻤﻴﺤﺎﺕ",
   generalMainHeaderST = "ﺗﺮﺟﻤﺎﺕ ﺍﻟﺘﻠﻤﻴﺤﺎﺕ - spitlooT",
   activateTooltipTranslations = "ﺗﻔﻌﻴﻞ ﺗﺮﺟﻤﺎﺕ ﺍﻟﺘﻠﻤﻴﺤﺎﺕ",
   activateTooltipTranslationsDESC = "ملخص: يترجم التلميحات وبعض عناصر الواجهة.\nنصيحة: إذا لاحظت بطء، عطّل ما لا تحتاجه من الخيارات.",
   translateItems = "ﻋﺮﺽ ﺍﻟﺘﻠﻤﻴﺤﺎﺕ ﺍﻟﻤﺘﺮﺟﻤﺔ ﻟﻸﻏﺮﺍﺽ",
   translateItemsDESC = "ملخص: يترجم تلميحات الأغراض.\nنصيحة: أوقفه إذا لا تحتاج ترجمة الأغراض.",
   translateSpells = "ﻋﺮﺽ ﺍﻟﺘﻠﻤﻴﺤﺎﺕ ﺍﻟﻤﺘﺮﺟﻤﺔ ﻟﻠﺘﻌﺎﻭﻳﺬ",
   translateSpellsDESC = "ملخص: يترجم تلميحات التعويذات.\nنصيحة: مفيد أثناء التعلم أو عند تجربة تعويذة جديدة.",
   translateTalents = "ﻋﺮﺽ ﺍﻟﺘﻠﻤﻴﺤﺎﺕ ﺍﻟﻤﺘﺮﺟﻤﺔ ﻟﻠﻤﻮﺍﻫﺐ",
   translateTalentsDESC = "ملخص: يترجم تلميحات المواهب.\nنصيحة: فعّله عندما تقارن المواهب.",
   translateTooltipTitle = "ﻋﺮﺽ ﻋﻨﻮﺍﻥ ﺍﻟﻤﺘﺮﺟﻢ ﻟﻠﻌﻨﺼﺮ ﺃﻭ ﺍﻟﺘﻌﻮﻳﺬﺓ ﺃﻭ ﺍﻟﻤﻮﻫﺒﺔ",
   translateTooltipTitleDESC = "ملخص: يعرض اسم العنصر/التعويذة مترجم في أعلى التلميح.\nنصيحة: فعّله حتى لو كنت تترك باقي النص أصلي.",
   showTooltipID = "ﻋﺮﺽ ﻣﻌﺮﻑ ﺍﻟﺘﻠﻤﻴﺢ",
   showTooltipIDDESC = "ملخص: يعرض رقم ID داخل التلميح.\nنصيحة: استخدمه عند الإبلاغ عن ترجمة ناقصة.",
   showTooltipHash = "ﻋﺮﺽ ﺭﻣﺰ ﺍﻟﺘﺠﺰﺋﺔ",
   showTooltipHashDESC = "ملخص: يعرض رمز التجزئة داخل التلميح.\nنصيحة: مفيد للمطورين لتتبع النص.",
   hideSellPrice = "ﺇﺧﻔﺎﺀ ﺳﻌﺮ ﺍﻟﺒﻴﻊ ﻟﻸﻏﺮﺍﺽ",
   hideSellPriceDESC = "ملخص: يخفي سطر سعر البيع من التلميحات.\nنصيحة: فعّله إذا تريد واجهة أنظف.",
   timerHoldTranslation = "ﺗﺄﺟﻴﻞ ﻋﺮﺽ ﺍﻟﺘﺮﺟﻤﺔ",
   timerLimitSeconds = "ﺗﺤﺪﻳﺪ ﻭﻗﺖ ﺍﻟﺘﺄﺟﻴﻞ",
   timerLimitSecondsDESC = "ملخص: مدة ظهور الترجمة عند إيقاف (عرض الترجمة بشكل مستمر).\nنصيحة: اختر وقت أقل إذا تريد التلميحات أسرع.",
   displayTranslationConstantly = "ﻋﺮﺽ ﺍﻟﺘﺮﺟﻤﺔ ﺑﺸﻜﻞ ﻣﺴﺘﻤﺮ",
   displayTranslationConstantlyDESC = "ملخص: يجعل الترجمة تظهر دائماً بدون مؤقت.\nنصيحة: عطّله إذا تريد الترجمة تظهر لثواني فقط.",
   savingUntranslatedTooltips = "ﺧﻴﺎﺭﺍﺕ ﺍﻟﺤﻔﻆ",
   saveUntranslatedTooltips = "ﺣﻔﻆ ﺍﻟﺘﻠﻤﻴﺤﺎﺕ ﻏﻴﺮ ﺍﻟﻤﺘﺮﺟﻤﺔ",
   saveUntranslatedTooltipsDESC = "ملخص: يحفظ التلميحات غير المترجمة في ملف الحفظ.\nنصيحة: شارك ملف الحفظ معنا لنضيف الترجمة.",
